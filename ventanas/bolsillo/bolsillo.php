...
$().ready(function() {
  ...
  $('#bolsillo_add').validate();
  
  $("#guardar_bolsillo_formulario").click(function(){
    var formulario = $("#bolsillo_add");
    var resultado = formulario.valid();
    
    if(resultado){
      var data = $(formulario).serializeArray(); // convert form to array
      data.push({name: "ejecutar", value: 'guardar_bolsillo_formulario'});
    ...
    <div class="d-flex justify-content-between flex-wrap">
      <div class="d-flex align-items-end flex-wrap">
        <div class="mr-md-3 mr-xl-5">
          <h2>Administración de bolsillos</h2>
        </div>
      </div>
    </div>
  </div>
...
<div id="capa_bolsillo_add" class="row">
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Crear bolsillo</h4>
        <form class="" name="bolsillo_add" id="bolsillo_add">
          <div class="row">
              ...
              <div class="col-md-3 form-group">
                  ...
                  <select class="form-control form-control-sm required" id="fk_idemp" name="fk_idemp">
...
?>
          ...
          <button type="button" id="guardar_bolsillo_formulario" class="btn btn-primary mb-2">Guardar</button>
        </form>
      </div>
    </div>
  </div>
...
<div id="capa_bolsillo_edit" class="row" style="display:none">
</div>
...
<div class="row">
  <div class="col-md-12 stretch-card">
    <div class="card">
      <div class="card-body">
        <p class="card-title">Lista bolsillos</p>
        ...
        <div class="collapse" id="collapseExample">
          <form class="row" name="filtro_bolsillo" id="filtro_bolsillo" onsubmit="return false;">
          ...
          <table id="table" class="table table-bordered table-responsive-md table-striped text-center" role="grid" style="width: 100%">
            <thead class="">
              <tr>
                ...
                <th data-field="acciones_bolsillo" data-sortable="false" data-visible="true"></th>
              </tr>
            </thead>
          </table>
...
$(document).ready(function(){//Se inicializa la tabla con estilos, el alto del documento y se ejecuta la accion para listar datos sobre la tabla
  $(".limpiar_filtro").click(function(){    
    $("#filtro_bolsillo").find('input:radio, input:checkbox').removeAttr('checked').removeAttr('selected');
    
    jQuery('#filtro_bolsillo').each(function(){
      this.reset();
    });
...
function procesamiento_listar(){
  ...
  var data = $('#filtro_bolsillo').serializeObject();
  
  $('#table').bootstrapTable('refreshOptions', {
    url: 'obtener_bolsillos.php',
...
<?php echo(pie()); ?>
<?php include_once($atras . "ventanas/bolsillo/librerias_reporte_bolsillo_js.php"); ?>